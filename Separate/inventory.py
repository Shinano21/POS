...
class InventoryManager:
    ...
    def show_add_item(self):
        ...
        markup_frame.grid(row=next_row, column=0, columnspan=2, sticky="ew", pady=self.scale_size(5))
        ...
        profitability_frame.grid(row=next_row, column=2, columnspan=2, sticky="ew", pady=self.scale_size(5))
        ...
        type_frame.grid(row=next_row + 1, column=0, columnspan=4, sticky="ew", pady=self.scale_size(5))
        tk.Label(type_frame, text="Type", font=("Helvetica", self.scale_size(18)), bg="#FFFFFF", fg="#212529").pack()
        ...
        type_combobox.pack(fill="x", pady=self.scale_size(5))

        custom_type_entry = tk.Entry(type_frame, font=("Helvetica", self.scale_size(18)), bg="#F8F9FA", fg="#212529")
        custom_type_entry.pack(fill="x", pady=self.scale_size(5))
    ...
    def add_item(self, item_id: str, name: str, item_type: str, retail_price: str, unit_price: str, quantity: str, supplier: str, window: tk.Toplevel):
        try:
            ...
            if not all([name, item_type]) or retail_price <= 0:
